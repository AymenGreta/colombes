...
function writeCookie(name, value, duration){
    ...
    // Ecris le cookie 
    sCookie=name+"="+value+';expires='+dToday.toLocaleString()+';path=';
    //Pour Firefox
 ...
 */
  ...
  */
  ...
  /**
   * Fonction évenementielle pour gérer le click sur le bouton cookie
   */
           ...
           function(){
               ...
               document.getElementById('tblCookies').innerHTML
                for (let i=0; i < aCookies.length; i++){
                    ...
                    oRow.appendChild(oCell);
                    document.getElementById('tblCookies').tbody.appendChild(oRow);
                }
           },
           false
       );
