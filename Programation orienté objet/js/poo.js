...
var ficheIndividu = function(lePrenom,leNom,leGenre,lAge,laProfession){
...
function nouvelleFiche(Prenom, Nom, Genre, Age, Profession) {
    var myFiche = new ficheIndividu(Prenom, Nom, Genre, Age, Profession);
    myFiche.afficherDonnees();
}

ficheIndividu.prototype.afficherDonnees = function(){
    if(this.genre=="F") {
