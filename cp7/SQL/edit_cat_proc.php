...
//var_dump($params); Var dump et exit permettent de vérifier que ça fonctionne 
//exit();

// Connexion à la BDD via MYSQLI et verif
...
// Récupération de l'image à téléverser (upload)
var_dump($_FILES);
if(isset($_FILES['PHOTO']) && $_FILES['PHOTO']['error'] !== UPLOAD_ERR_NO_FILE){
    ...
    if (!in_array($file_ext, $file_exts)){
        $errors[]= '<p> Extension du fichier non autorisé :' . implode(',', $file_exts);
    }
